...
<head>
  ...
  <link href="resources/images/france_favicon.ico" rel="shortcut icon" type="image/x-icon"/>
        ...
        <div id="sidebar">
          <ul>
            ...
            <li>
              <h2>Project Pages</h2>
              <ul>
                <li><a href="https://github.com/bguerout/runtimeXceptions">GitHub</a></li>
                <li><a href="https://github.com/bguerout/runtimeXceptions/wiki">Wiki</a> (Backlog &
                  Improvements
                  list)
                </li>
